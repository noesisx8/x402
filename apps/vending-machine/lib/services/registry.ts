...
export const VENDING_SERVICES: VendingService[] = [
  ...
  {
    slug: "bundle-outbound",
    name: "Outbound pack (email + IP + HEAD)",
    description:
    ...
    category: "bundle",
    queryParams: [
      { name: "email", required: true, description: "Email address to validate" },
      { name: "ip", required: true, description: "IPv4 or IPv6 to geolocate" },
      { name: "url", required: true, description: "Public https:// URL for HEAD probe" },
    ],
    handler: bundleOutboundHandler,
    discovery: {
      exampleQuery: {
        email: "test@gmail.com",
        ip: "8.8.8.8",
  ...
  },
  {
    ...
    discovery: {
      ...
      exampleOutput: {
        ...
        forecast: [{ t: "2026-07-10T12:00:00Z", open: 1, high: 1, low: 1, close: 1, volume: 0 }],
        summary: { direction: "up", pct_change: 0.0 },
