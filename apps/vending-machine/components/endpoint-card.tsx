...
export function EndpointCard({ service, featured = false }: EndpointCardProps) {
        ...
        <div className="relative flex h-full flex-col rounded-3xl bg-[linear-gradient(135deg,rgba(24,24,27,0.90),rgba(9,9,11,0.96))] p-5">
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            <Link
              ...
              className="rounded-xl bg-emerald-300 px-4 py-2.5 font-semibold text-zinc-950 shadow-[0_0_28px_rgba(16,185,129,0.24)] transition duration-300 hover:bg-cyan-200 hover:shadow-[0_0_44px_rgba(34,211,238,0.30)]"
            >
              Try bundle
            </Link>
            <Link
              href={endpointPath}
              className="rounded-xl border border-white/10 bg-white/[0.03] px-4 py-2.5 text-zinc-200 transition duration-300 hover:border-lime-300/40 hover:bg-lime-300/[0.06] hover:text-lime-100"
            >
              View API
            </Link>
          </div>
  ...
  return (
    ...
    >
      <div className={`absolute inset-0 bg-gradient-to-br ${hue} opacity-0 transition duration-500 group-hover:opacity-100 group-hover:hue-rotate-30`} />
      <div className="absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-emerald-300/70 to-transparent" />
      <div className="relative grid gap-5 rounded-3xl bg-[linear-gradient(135deg,rgba(24,24,27,0.90),rgba(9,9,11,0.96))] p-5 md:grid-cols-[minmax(0,1fr)_210px] md:items-start">
        <div>
          <div className="flex flex-wrap items-center gap-2">
            <span className="rounded-full border border-emerald-300/25 bg-emerald-300/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-emerald-200 shadow-[0_0_24px_rgba(16,185,129,0.12)]">
              {categoryLabel(service)}
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-stretch">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm sm:w-36 sm:grid-cols-1">
              <Link
                href={`/test?slug=${encodeURIComponent(service.slug)}`}
                className="inline-flex items-center justify-center rounded-xl bg-emerald-300 px-4 py-2.5 font-semibold text-zinc-950 shadow-[0_0_28px_rgba(16,185,129,0.24)] transition duration-300 hover:scale-[1.02] hover:bg-cyan-200 hover:shadow-[0_0_44px_rgba(34,211,238,0.32)]"
              >
                Test payment
              </Link>
              <Link
